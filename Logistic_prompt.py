...
def Logistic_pmt(schema_det, total_row, total_col, target, new_table, goal_name, threshold, models_names):
...
Instructions:
 ...
 here is more detail about the dataset - 
        ...
        Note: Strictly import json in the code.
...
(Note: Omit the first line (```python) and the last line keyword (```).) 
