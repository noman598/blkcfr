...
def ordinal_pmpt(schema_det, total_row, total_col, target, new_table, goal_name, threshold, models_names):
...
!please avoid this issues 
#label_mapping = dict(zip(label_encoder.classes_, label_encoder.transform(label_encoder.classes_))
#0|api_config  |                         ^
#0|api_config  | SyntaxError: '(' was never closed
...
results['Ordinal Logistic Regression']['Decoding'] = reversed_mapping
results['Ordinal Logistic Regression']['P-values'] = p_values_dict
